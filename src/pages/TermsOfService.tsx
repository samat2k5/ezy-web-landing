  ...
  return (
    <div className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      ...
      <div className="prose prose-slate prose-emerald max-w-none">
        ...
        <p>
          <strong>3.2. Statutory and Payroll Assistance.</strong> ezyHR assists with CPF, SDL, SHG, payroll, and statutory processes. This does not constitute legal, tax, accounting, or government advice. The Customer is responsible for reviewing relevant inputs and outputs and for approving and making applicable statutory filings and payments.
        </p>
