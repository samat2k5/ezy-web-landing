  ...
  return (
    <div className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      ...
      <div className="prose prose-slate prose-emerald max-w-none">
        ...
        <p>
          We retain personal data only for as long as it is necessary to fulfill the purposes for which it was collected, or as required by applicable business or legal purposes. When retention is no longer necessary for such purposes, we will take reasonable steps to delete, anonymise or otherwise cease retaining the personal data.
        </p>
