...
export const AiSection: React.FC = () => {
  ...
  return (
    <section id="ai" className="py-24 bg-ambient-lavender text-slate-900 relative border-b border-violet-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-slate-950 leading-tight">
            Ask your HR data <br />
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-violet-700 via-purple-600 to-indigo-600">
              anything.
            </span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {aiCapabilities.map((ai, idx) => {
            ...
            return (
              <div 
                key={idx}
                className="bg-white p-6 rounded-3xl border border-violet-100 hover:border-violet-300 transition-all flex flex-col justify-between shadow-xs hover:shadow-md"
              >
                <div>
