...
export const HeroSection: React.FC<HeroSectionProps> = ({ onOpenDemo, onOpenTrial }) => {
  ...
  return (
    <section className="relative pt-32 pb-24 lg:pt-40 lg:pb-36 bg-ambient-ice text-slate-900 overflow-hidden border-b border-slate-200/80">
      ...
      {/* Soft Multi-colour Ambient Glows */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1100px] h-[550px] bg-gradient-to-tr from-blue-200/50 via-cyan-200/35 to-emerald-200/45 blur-[150px] rounded-full pointer-events-none" />
      <div className="absolute top-1/3 right-5 w-[600px] h-[450px] bg-purple-200/35 blur-[140px] rounded-full pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Top Tagline Badge */}
        <div className="flex justify-center mb-6">
          <div className="inline-flex items-center gap-2.5 px-4.5 py-1.5 rounded-full bg-white/95 border border-slate-200 text-xs text-slate-700 backdrop-blur-md shadow-sm">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6">
          ...
          <div className="pt-6 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-xs font-bold text-slate-700">
        ...
        {/* Oversized Product Hero Dashboard (65-70% Visual Area with Overlapping Panels) */}
        <div className="mt-16 lg:mt-24 max-w-6xl mx-auto relative">
          
          {/* Overlapping Floating Micro-Notification 1 */}
          <div className="hidden sm:flex absolute -top-6 -right-6 z-20 items-center gap-2.5 px-4.5 py-2.5 rounded-2xl bg-white border border-emerald-500/40 text-xs font-bold text-emerald-800 shadow-2xl backdrop-blur-md animate-float">
            <CheckCircle2 className="w-4.5 h-4.5 text-emerald-600" />
            <span>Payroll Batch Approved</span>
          </div>

          {/* Overlapping Floating Micro-Notification 2 */}
          <div className="hidden sm:flex absolute top-1/2 -left-8 z-20 items-center gap-2.5 px-4.5 py-2.5 rounded-2xl bg-white border border-cyan-500/40 text-xs font-bold text-cyan-800 shadow-2xl backdrop-blur-md animate-float" style={{ animationDelay: '1.5s' }}>
            <Clock className="w-4.5 h-4.5 text-cyan-600" />
            <span>Attendance Recorded</span>
          </div>

          {/* Overlapping Floating Micro-Notification 3 */}
          <div className="hidden sm:flex absolute -bottom-6 right-8 z-20 items-center gap-2.5 px-4.5 py-2.5 rounded-2xl bg-white border border-purple-500/40 text-xs font-bold text-purple-800 shadow-2xl backdrop-blur-md animate-float" style={{ animationDelay: '2.5s' }}>
