    ...
    <section className="py-24 bg-white text-slate-900 relative border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          {/* Left Column: Security Posture Visual Dashboard */}
          <div className="lg:col-span-6 bg-slate-950 p-6 sm:p-8 rounded-3xl border border-slate-800 shadow-2xl space-y-5 text-white">
            <div className="flex items-center justify-between border-b border-slate-800 pb-4">
              <div className="flex items-center gap-2">
                <ShieldCheck className="w-5 h-5 text-emerald-400" />
                <span className="text-xs font-bold text-white uppercase tracking-wider">Security Control Center</span>
              </div>
            ...
            <div className="space-y-3 font-mono text-xs">
              ...
              <div className="p-4 bg-slate-900 rounded-2xl border border-slate-800 flex items-center justify-between">
                ...
                <span className="text-blue-400 font-bold">2FA / SSO Enabled</span>
              </div>
              ...
              <div className="p-4 bg-slate-900 rounded-2xl border border-slate-800 flex items-center justify-between">
                ...
                <span className="text-emerald-400 font-bold">Aligned & Audited</span>
              </div>
              ...
              <div className="p-4 bg-slate-900 rounded-2xl border border-slate-800 flex items-center justify-between">
                ...
                <span className="text-cyan-400 font-bold">Daily Redundant</span>
              </div>
            </div>
          </div>
