...
export const SecuritySection: React.FC = () => {
  const securityPillars = [
    ...
    { title: 'Singapore PDPA Privacy Controls', desc: 'Role-based permissions, audit trails and privacy controls for responsible employee-data management.' },
    ...
    <section id="security" className="py-24 bg-white text-slate-900 relative border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 bg-white text-slate-900 p-7 sm:p-9 rounded-2xl border border-slate-200 shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-slate-200 pb-4">
              <div className="flex items-center gap-2.5">
                <ShieldCheck className="w-5 h-5 text-emerald-600" />
                <span className="text-xs font-black text-slate-900 uppercase tracking-wider">Enterprise Security Dashboard</span>
              </div>
              <span className="px-2.5 py-0.5 rounded bg-emerald-100 text-emerald-700 text-[10px] font-extrabold border border-emerald-200 font-mono">
                DEMO DATA
              </span>
            </div>
            ...
            <div className="space-y-3 font-mono text-xs">
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 flex items-center justify-between">
                <div className="flex items-center gap-3 font-sans text-slate-700 font-bold">
              ...
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 flex items-center justify-between">
                ...
                <span className="text-cyan-700 font-bold">RBAC Enforced</span>
              </div>
              ...
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 flex items-center justify-between">
                ...
                <span className="text-teal-700 font-bold">Data Privacy Aligned</span>
              </div>
              ...
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 flex items-center justify-between">
                ...
                <span className="text-sky-700 font-bold">Daily Backups</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="space-y-2">
              <h3 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900">
                Security &amp; PDPA controls for your workforce data.
              </h3>
              <p className="text-sm text-slate-600">
                Every sensitive HR and payroll action creates an immutable, timestamped audit log entry — giving you complete visibility and control.
              </p>
            </div>
            
            {/* Audit log events container */}
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-3 font-mono text-xs">
