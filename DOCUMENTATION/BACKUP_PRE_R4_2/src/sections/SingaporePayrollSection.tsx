...
export const SingaporePayrollSection: React.FC<SingaporePayrollSectionProps> = ({ onOpenDemo }) => {
  ...
  return (
    <section id="payroll" className="py-24 bg-white text-slate-900 relative border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-slate-950 leading-tight">
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-700 via-indigo-600 to-violet-700">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-7 gap-3.5">
            {payrollWorkflow.map((s, idx) => (
              <div 
                key={idx}
                className="bg-slate-50 p-4.5 rounded-2xl border border-slate-200 relative hover:border-blue-500 transition-all flex flex-col justify-between shadow-xs"
              >
                <div>
