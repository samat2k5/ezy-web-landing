...
base_dir = r"c:\Users\mathi\Desktop\AntiGravity Demos\ezyHR.sg - Landing Page R1\DOCUMENTATION\R4_2_VISUAL_REVIEW"

img_1440_path = os.path.join(base_dir, "ezyhr_r4_2_1440x900.png")
img_1280_path = os.path.join(base_dir, "ezyhr_r4_2_1280x800.png")
img_390_path = os.path.join(base_dir, "ezyhr_r4_2_390x844.png")
img_full_path = os.path.join(base_dir, "ezyhr_r4_2_full_page.png")
...
draw.text((x1 + 20, margin + 15), "R4.2 DESKTOP 1440×900", fill=(52, 211, 153), font=font_title)
...
draw.text((x2 + 20, margin + 15), "R4.2 LAPTOP 1280×800", fill=(56, 189, 248), font=font_title)
...
draw.text((x3 + 20, row2_y + 15), "R4.2 MOBILE 390×844", fill=(251, 191, 36), font=font_title)
...
draw.text((x4 + 20, row2_y + 15), "R4.2 FULL PAGE SCREENSHOT", fill=(192, 132, 252), font=font_title)
sheet.paste(i_full, (x4, y4))

output_path = os.path.join(base_dir, "R4_2_VISUAL_CONTACT_SHEET.png")
