...
import { ArrowRight, CheckCircle, Users, DollarSign, Clock, Calendar, Sparkles, TrendingUp, Bell, Bot, ShieldCheck, ChevronRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6">
          ...
          <div className="pt-3 flex flex-col sm:flex-row items-center justify-center gap-3.5 sm:gap-4">
            <button
              onClick={onOpenDemo}
              className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-emerald-500 via-teal-500 to-blue-600 hover:from-emerald-400 hover:to-blue-500 text-slate-950 font-extrabold rounded-2xl text-base shadow-xl shadow-emerald-500/25 transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2.5"
            >
        ...
        {/* Large Product Hero Interface Composition (55-65% Visual Area) */}
                ...
                <div className="space-y-6 animate-fadeIn">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="bg-slate-900 p-5 rounded-2xl border border-slate-800">
                      ...
                      <div className="text-lg font-bold text-violet-400 mt-1">3 Anomaly Alerts</div>
