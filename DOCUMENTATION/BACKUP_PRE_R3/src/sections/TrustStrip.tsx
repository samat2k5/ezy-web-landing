...
export const TrustStrip: React.FC = () => {
  ...
  return (
    <section className="bg-white border-y border-slate-200 py-8 text-slate-800 shadow-sm">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6 text-center">
          {trustPillars.map((item, idx) => {
            ...
            return (
              <div 
                key={idx} 
                className="flex items-center justify-center gap-2.5 p-3 rounded-2xl bg-slate-50 border border-slate-200 hover:border-slate-300 transition-colors shadow-xs"
              >
