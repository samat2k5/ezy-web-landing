...
import { UserCheck, Network, User, BellRing, CheckCircle2, ArrowRight, FileText } from 'lucide-react';
...
export const CoreHRSection: React.FC<CoreHRSectionProps> = ({ onOpenDemo }) => {
  ...
  return (
    <section id="features" className="py-24 bg-white text-slate-900 relative border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Two-Column Showcase Composition */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          
          {/* Left Column: Large Product UI Showcase */}
          <div className="lg:col-span-7 bg-slate-950 p-6 sm:p-8 rounded-3xl border border-slate-800 shadow-2xl space-y-5 text-white">
            <div className="flex items-center justify-between border-b border-slate-800 pb-4 text-xs">
              <span className="font-bold text-white flex items-center gap-2">
                <FileText className="w-4 h-4 text-emerald-400" /> Digital Employee Master File
              </span>
            ...
            <div className="flex items-center gap-4 bg-slate-900 p-5 rounded-2xl border border-slate-800">
              <div className="w-14 h-14 rounded-2xl bg-emerald-500 text-slate-950 font-black flex items-center justify-center text-lg shadow-md">
                TW
              </div>
              <div>
                ...
                <span className="text-[11px] text-slate-500 block mt-1">Emp ID: SG-2024-0042 • Joined 15 Jan 2022</span>
              </div>
            </div>
          ...
          {/* Right Column: Editorial Marketing Narrative */}
