...
export const AiSection: React.FC = () => {
  ...
  return (
    <section id="ai" className="py-24 bg-white text-slate-900 relative border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-purple-100 border border-purple-200 text-purple-800 text-xs font-bold uppercase tracking-wider">
            <Sparkles className="w-4 h-4 text-purple-700" /> Next-Generation HR AI
          </div>
          <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-slate-900 leading-tight">
            Your HR assistant, <br />
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-700 via-purple-600 to-teal-600">
              always ready.
            </span>
          </h2>
        ...
        <div className="max-w-3xl mx-auto bg-slate-950 rounded-3xl border border-slate-800 shadow-2xl p-6 sm:p-8 mb-16 space-y-4 text-white">
          <div className="flex items-center justify-between border-b border-slate-800 pb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-sm font-bold text-white">ezyHR AI Assistant Demo</h3>
                <span className="text-[11px] text-slate-400">Policy & Payroll Anomaly Detection</span>
              </div>
            </div>
            <span className="px-3 py-0.5 rounded bg-purple-500/20 text-purple-300 text-[10px] font-extrabold tracking-wider border border-purple-500/30">
              DEMONSTRATION DATA
            </span>
          </div>
          ...
          <div className="space-y-3.5 py-2 text-xs">
            ...
            <div className="flex items-start justify-end gap-2">
              <div className="bg-purple-600 text-white p-3.5 rounded-2xl rounded-tr-none max-w-md font-medium text-xs sm:text-sm">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="bg-slate-900 text-slate-200 p-4 rounded-2xl rounded-tl-none border border-slate-800 max-w-lg space-y-2 text-xs sm:text-sm">
                <span className="font-bold text-purple-300 block">3 employees require review before finalizing August 2026 payroll:</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {aiCapabilities.map((ai, idx) => {
            ...
            return (
              <div 
                key={idx}
                className="bg-slate-50 p-6 rounded-3xl border border-slate-200 hover:border-slate-300 transition-all flex flex-col justify-between shadow-xs hover:shadow-md"
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-11 h-11 rounded-2xl bg-purple-100 text-purple-700 flex items-center justify-center border border-purple-200 font-bold">
