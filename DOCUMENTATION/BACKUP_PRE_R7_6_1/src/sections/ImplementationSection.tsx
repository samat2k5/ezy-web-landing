      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-slate-950 leading-tight">
            From setup to HR-ready, faster.
          </h2>
          <p className="text-base sm:text-lg text-slate-600 leading-relaxed">
            Starting fresh? Set up your organisation and begin using ezyHR within minutes. Bringing existing HR data? Our guided migration can help get you operational within hours.
          </p>
        </div>
