...
export const HeroSection: React.FC<HeroSectionProps> = ({ onOpenDemo, onOpenTrial }) => {
  ...
  return (
    <section className="relative pt-32 pb-24 lg:pt-40 lg:pb-36 bg-ambient-ice text-slate-900 overflow-hidden border-b border-slate-200/80">
      
      {/* Soft Light Multi-colour Ambient Glow Backgrounds */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[500px] bg-gradient-to-tr from-blue-200/40 via-cyan-200/30 to-emerald-200/40 blur-[140px] rounded-full pointer-events-none" />
      <div className="absolute top-1/3 right-10 w-[500px] h-[400px] bg-purple-200/30 blur-[130px] rounded-full pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Top Tagline Badge */}
        <div className="flex justify-center mb-6">
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-white/90 border border-slate-200 text-xs text-slate-700 backdrop-blur-md shadow-sm">
            ...
            <span className="text-slate-600 font-semibold">Built for Singapore Employment Requirements</span>
          </div>
        </div>
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6">
          ...
          <div className="pt-3 flex flex-col sm:flex-row items-center justify-center gap-3.5 sm:gap-4">
            <button
              onClick={onOpenDemo}
              className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-emerald-500 via-teal-500 to-blue-600 hover:from-emerald-600 hover:to-blue-700 text-slate-950 font-extrabold rounded-2xl text-base shadow-xl shadow-emerald-500/20 transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2.5 ring-1 ring-emerald-400/40"
            >
            ...
            <button
              onClick={onOpenTrial}
              className="w-full sm:w-auto px-8 py-4 bg-white hover:bg-slate-50 text-slate-800 font-bold rounded-2xl text-base border border-slate-200 shadow-sm transition-all flex items-center justify-center gap-2"
            >
              Start Free Trial
            </button>
          </div>
          ...
          <div className="pt-6 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-xs font-bold text-slate-600">
        ...
        {/* Large Immersive Product Interface Composition (60% Visual Area) */}
        <div className="mt-14 lg:mt-20 max-w-6xl mx-auto relative">
          
          {/* Floating Micro-Badge 1: Top Right */}
          <div className="hidden sm:flex absolute -top-5 -right-4 z-20 items-center gap-2.5 px-4 py-2 rounded-2xl bg-white border border-emerald-500/40 text-xs font-bold text-emerald-800 shadow-xl backdrop-blur-md animate-float">
            <CheckCircle2 className="w-4 h-4 text-emerald-600" />
            <span>Payroll Batch Approved</span>
          </div>

          {/* Floating Micro-Badge 2: Left Middle */}
          <div className="hidden sm:flex absolute top-1/2 -left-6 z-20 items-center gap-2.5 px-4 py-2 rounded-2xl bg-white border border-cyan-500/40 text-xs font-bold text-cyan-800 shadow-xl backdrop-blur-md animate-float" style={{ animationDelay: '1.5s' }}>
            <Clock className="w-4 h-4 text-cyan-600" />
            <span>Attendance Recorded</span>
          </div>

          {/* Floating Micro-Badge 3: Bottom Right */}
          <div className="hidden sm:flex absolute -bottom-5 right-10 z-20 items-center gap-2.5 px-4 py-2 rounded-2xl bg-white border border-purple-500/40 text-xs font-bold text-purple-800 shadow-xl backdrop-blur-md animate-float" style={{ animationDelay: '2.5s' }}>
          ...
          <div className="relative rounded-3xl bg-slate-950 border border-slate-800 shadow-hero-shadow overflow-hidden group">
            ...
            {/* Dashboard Workspace */}
            <div className="p-6 sm:p-8 bg-slate-950 space-y-6 text-white">
