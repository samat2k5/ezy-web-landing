        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="pt-2 text-[11px] text-slate-400 space-y-1 bg-slate-900/80 p-3 rounded-xl border border-slate-800/80">
              <p className="text-slate-300 font-bold">Brand & Parent Company Relationship:</p>
              <p>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><a href="#payroll" className="hover:text-emerald-400 transition-colors">Singapore Payroll Engine</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><a href="https://hr.ezy.sg/" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 transition-colors flex items-center gap-1">About ezyHR <ExternalLink className="w-3 h-3 text-slate-500" /></a></li>
        ...
        <div className="pt-8 border-t border-slate-900 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-slate-500">
          ...
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1 text-slate-400">
              <Globe className="w-3.5 h-3.5 text-emerald-400" /> https://hr.ezy.sg/
            </span>
            <span>•</span>
